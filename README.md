...
Ansible 2.4, works with Ubuntu Xenial, Bionic and Centos 7.x
...
file by defining `boss__dnsmasq__resolvconf: true` and `boss__dnsmasq__host_*` parameters.
